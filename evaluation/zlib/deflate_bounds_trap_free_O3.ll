...
24:                                               ; preds = %4
; LIMIT STUDY: Oracle neutralized -> tail call void @llvm.ubsantrap(i8 18) #14, !nosanitize !54
...
56:                                               ; preds = %25
; LIMIT STUDY: Oracle neutralized -> tail call void @llvm.ubsantrap(i8 13) #15, !nosanitize !54
  unreachable, !nosanitize !54
}
...
122:                                              ; preds = %38
; LIMIT STUDY: Oracle neutralized -> tail call void @llvm.ubsantrap(i8 29) #15, !nosanitize !54
  unreachable, !nosanitize !54

123:                                              ; preds = %95
; LIMIT STUDY: Oracle neutralized -> tail call void @llvm.ubsantrap(i8 31) #15, !nosanitize !54
  unreachable, !nosanitize !54

124:                                              ; preds = %99
; LIMIT STUDY: Oracle neutralized -> tail call void @llvm.ubsantrap(i8 37) #15, !nosanitize !54
  unreachable, !nosanitize !54
}
