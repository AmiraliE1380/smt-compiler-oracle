; ModuleID = 'benchmarks/9/9.c'
source_filename = "benchmarks/9/9.c"
...
define dso_local void @benchmark_div_rem_prime(i32 noundef %0) local_unnamed_addr #0 {
  %2 = add i32 %0, -35
  %3 = icmp ult i32 %2, 7
...
10:                                               ; preds = %4
  %11 = trunc nuw nsw i32 %2 to i16
  %12 = udiv i16 10000, %11
  %13 = zext nneg i16 %12 to i32
  br label %14

14:                                               ; preds = %4, %10, %1
  %15 = phi i32 [ %13, %10 ], [ 0, %4 ], [ 0, %1 ]
