; ModuleID = 'benchmarks/6/6_idealized.c'
source_filename = "benchmarks/6/6_idealized.c"
...
define dso_local void @benchmark_transitivity(double noundef %0, double noundef %1, double noundef %2, double noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef 0.000000e+00)
  ret void
}
