; ModuleID = 'benchmarks/10/10_idealized.c'
source_filename = "benchmarks/10/10_idealized.c"
...
define dso_local void @benchmark_linear_math(double noundef %0, double noundef %1, double noundef %2) local_unnamed_addr #0 {
  %4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef 0.000000e+00)
  ret void
}
